Sub AllStocksAnalysisRefactored()
 ...
 For tickerIndex= 0 to 11
    ...
    For i = 2 To RowCount
    'Check if curent row matches ticker
        ...
        If Cells(i-1, 1).Value <> tickers(tickerIndex) And Cells(i, 1).value = tickerIndex   Then
        ...
        'If  Then
            ...
            If Cells(i+1, 1).Value <> Cells(i, 1) then tickerIndex= tickerIndex + 1
    ...
    For i = 0 To 11
        ...
        Worksheets("All Stocks Analysis").Activate
        Cells(4+i, 1)=tickerIndex
        Cells(4+i, 2)= tickerVolumes
        Cells(4+i, 3)= tickerEndingPrices / tickerStartingPrices - 1 
